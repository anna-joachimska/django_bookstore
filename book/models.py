...
class Book(models.Model):
    ...
    publishing_house = models.ForeignKey('publishing_house.PublishingHouse',on_delete=models.CASCADE, null=True, blank=True, unique=False)
    bookstores = models.ManyToManyField('bookstore.Bookstore', blank=True, unique=False)
